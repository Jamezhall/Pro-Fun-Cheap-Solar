...
function get_circuit_connector_sprites(mainOffset, shadowOffset, connectorNumber)
  ...
  local result =
  {
    connector_main =
    {
      filename = "__ProFunCheapSolar__/graphics/entity/circuit-connector/circuit-connector-main.png",
      priority = "low",
      width = 28,
      height = 27,
    ...
    led_red =
    {
      filename = "__ProFunCheapSolar__/graphics/entity/circuit-connector/circuit-connector-led-red.png",
      priority = "low",
      width = 20,
      height = 16,
    ...
    led_green =
    {
      filename = "__ProFunCheapSolar__/graphics/entity/circuit-connector/circuit-connector-led-green.png",
      priority = "low",
      width = 20,
      height = 16,
      x = 20*(connectorNumber%8),
    ...
    led_blue =
    {
      filename = "__ProFunCheapSolar__/graphics/entity/circuit-connector/circuit-connector-led-blue.png",
      priority = "low",
      width = 21,
      height = 22,
    ...
    logistic_animation =
    {
      filename = "__ProFunCheapSolar__/graphics/entity/circuit-connector/circuit-connector-logistic-animation.png",
      priority = "low",
      blend_mode = "additive",
      line_length = 4,
      width = 43,
  ...
  if (not (shadowOffset == nil)) then
    ...
    {
      filename = "__ProFunCheapSolar__/graphics/entity/circuit-connector/circuit-connector-shadow.png",
      priority = "low",
      width = 34,
      height = 26,
...
-- cheap accumulator
require("prototypes.entity.cheap-accumulator")
require("prototypes.item.cheap-accumulator")
require("prototypes.crafting.cheap-accumulator")
require("prototypes.technology.cheap-accumulator")
  -- cheap solar
require("prototypes.entity.cheap-solar")
require("prototypes.item.cheap-solar")
require("prototypes.crafting.cheap-solar")
require("prototypes.technology.cheap-solar")
